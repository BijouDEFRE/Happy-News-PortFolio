...
VALUES
('Micheline', 'Dupont', '4 rue de la Prefecture', 87160, 'Arnac la poste', 'micheline@laposte.fr', 'mdp', 'le papier sarl', 'paper plane', 85247087300017, 9, 37);

INSERT INTO "article" ("article_title", "description", "picture_url", "price", "is_news", "user_id", "activity_id") VALUES
('Lot de 10 cahiers', 'Lot de cahiers avec du poil autour', '', 10, true, 9, 37);
